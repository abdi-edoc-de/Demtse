...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Demጽ.Entities.Users", b =>
                {
                    b.Property<string>("ChaId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Demጽ.Entities.Channel", b =>
                {
                    b.HasOne("Demጽ.Entities.Users", "Owner")
                        .WithOne("Channel")
                        .HasForeignKey("Demጽ.Entities.Channel", "UserId");
                });
            ...
            modelBuilder.Entity("Demጽ.Entities.Subscribe", b =>
                {
                    ...
                    b.HasOne("Demጽ.Entities.Users", "User")
                        .WithMany("Subscribtion")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Demጽ.Entities.Users", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
