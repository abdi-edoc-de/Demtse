...
namespace Demጽ.Migrations
{
    ...
    [Migration("20210909082728_FixBugInForiegnKeySubscribe")]
    partial class FixBugInForiegnKeySubscribe
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Demጽ.Entities.Channel", b =>
                {
                    b.HasOne("Demጽ.Entities.User", "Owner")
                        .WithMany("Channels")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Demጽ.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
